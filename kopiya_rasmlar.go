...
// 		dest:    rl.Rectangle{X: 200, Y: 250, Width: 88, Height: 94},
// 	}
// 	dino1 := Object{
// 		texture: texture,
// 		source:  rl.Rectangle{X: 1338, Y: 0, Width: 88, Height: 94},
// 		dest:    rl.Rectangle{X: 300, Y: 250, Width: 88, Height: 94},
// 	}
// 	dino2 := Object{
// 		texture: texture,
// 		source:  rl.Rectangle{X: 1426, Y: 0, Width: 88, Height: 94},
// 		dest:    rl.Rectangle{X: 410, Y: 250, Width: 88, Height: 94},
// 	}
// 	dino3 := Object{
// 		texture: texture,
// 		source:  rl.Rectangle{X: 1514, Y: 0, Width: 88, Height: 94},
// 		dest:    rl.Rectangle{X: 515, Y: 250, Width: 88, Height: 94},
// 	}
// 	dino4 := Object{
// 		texture: texture,
// 		source:  rl.Rectangle{X: 1602, Y: 0, Width: 88, Height: 94},
// 		dest:    rl.Rectangle{X: 625, Y: 250, Width: 88, Height: 94},
// 	}
// 	dino5 := Object{
// 		texture: texture,
// 		source:  rl.Rectangle{X: 1690, Y: 0, Width: 88, Height: 94},
// 		dest:    rl.Rectangle{X: 725, Y: 250, Width: 88, Height: 94},
// 	}
// 	dino6 := Object{
// 		texture: texture,
// 		source:  rl.Rectangle{X: 1778, Y: 0, Width: 88, Height: 94},
// 		dest:    rl.Rectangle{X: 825, Y: 250, Width: 88, Height: 94},
// 	}
// 	dino7p := Object{
// 		texture: texture,
// 		source:  rl.Rectangle{X: 1860, Y: 20, Width: 123, Height: 73},
// 		dest:    rl.Rectangle{X: 0, Y: 380, Width: 123, Height: 73},
// 	}
// 	dino8p := Object{
// 		texture: texture,
// 		source:  rl.Rectangle{X: 1985, Y: 20, Width: 123, Height: 73},
// 		dest:    rl.Rectangle{X: 130, Y: 380, Width: 123, Height: 73},
// 	}

// 	return []Object{dino0, dino1, dino2, dino3, dino4, dino5, dino6, dino7p, dino8p}
// }

// func load_kaktuslar(texture rl.Texture2D) []Object {

// 	kaktuscha1 := Object{
// 		texture: texture,
// 		source:  rl.Rectangle{X: 515, Y: 0, Width: 67, Height: 80},
// 		dest:    rl.Rectangle{X: 1300, Y: 280, Width: 65, Height: 70},
// 		speed:   rl.Vector2{X: 3, Y: 0},
// 	}
// 	kaktuscha2 := Object{
// 		texture: texture,
// 		source:  rl.Rectangle{X: 515, Y: 0, Width: 33, Height: 80},
// 		dest:    rl.Rectangle{X: 1400, Y: 280, Width: 33, Height: 70},
// 		speed:   rl.Vector2{X: 3, Y: 0},
// 	}
// 	kaktus2 := Object{
// 		texture: texture,
// 		source:  rl.Rectangle{X: 850, Y: 0, Width: 103, Height: 100},
// 		dest:    rl.Rectangle{X: 1190, Y: 250, Width: 88, Height: 94},
// 		speed:   rl.Vector2{X: 3, Y: 0},
// 	}
// 	kaktus1 := Object{
// 		texture: texture,
// 		source:  rl.Rectangle{X: 803, Y: 0, Width: 47, Height: 100},
// 		dest:    rl.Rectangle{X: 1100, Y: 250, Width: 44, Height: 94},
// 		speed:   rl.Vector2{X: 3, Y: 0},
// 	}

// 	return []Object{kaktus1, kaktus2, kaktuscha1, kaktuscha2}
// }
...
// 		dest:    rl.Rectangle{X: 0, Y: 50, Width: 88, Height: 40},
// 		speed:   rl.Vector2{X: 1, Y: 0},
// 	}
// 	bulut2 := Object{
// 		texture: texture,
// 		source:  rl.Rectangle{X: 170, Y: 0, Width: 88, Height: 70},
// 		dest:    rl.Rectangle{X: 100, Y: 50, Width: 110, Height: 70},
// 		speed:   rl.Vector2{X: 1, Y: 0},
// 	}
// 	bulut3 := Object{
// 		texture: texture,
// 		source:  rl.Rectangle{X: 170, Y: 0, Width: 88, Height: 70},
// 		dest:    rl.Rectangle{X: 500, Y: 50, Width: 140, Height: 90},
// 		speed:   rl.Vector2{X: 1, Y: 0},
// 	}
